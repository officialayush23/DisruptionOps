  ...
  return (
    <div className="bg-background fixed inset-0 z-50 flex flex-col">
      <div className="relative min-h-0 flex-1">
        ...
        {panel && showPanel && (
          <aside
            className="absolute right-3 top-14 bottom-3 z-10 flex w-[360px] max-w-[calc(100vw-1.5rem)] flex-col
                       overflow-hidden rounded-lg border border-slate-500/30
                       bg-[rgb(9_12_20/0.94)] shadow-2xl backdrop-blur-sm"
          >
